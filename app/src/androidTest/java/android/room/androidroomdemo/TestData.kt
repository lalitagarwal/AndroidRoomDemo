...
object TestData {
    ...
    private val FAKE_TRACK1 = Track(trackName = "The Thin Ice", artistId = 1, duration = 245)
    private val FAKE_TRACK2 = Track(trackName = "Another Brick in the Wall", artistId = 2, duration = 546)
    private val FAKE_TRACK3 = Track(trackName = "One Fine Morning", artistId= 2, duration = 362 )
    private val FAKE_TRACK4 = Track(trackName = "The Calling", artistId= 2, duration = 238)
